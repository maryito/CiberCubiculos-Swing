...
public class VentanaRegistrar extends javax.swing.JFrame{
    ...
    private void Campos_act_dect(boolean est){
        if (est){
           txt_Nombre.setEnabled(true);
           rb_Femenino.setEnabled(true);
           rb_Masculino.setEnabled(true);
           cb_ACD.setEnabled(true);
           cb_MP.setEnabled(true);
           cb_ING.setEnabled(true);
           cb_DR.setEnabled(true);
           cb_CA.setEnabled(true);
           cb_GLION.setEnabled(true);
           cb_CS.setEnabled(true);
           cb_Otros.setEnabled(true); 
        }else{
            txt_Nombre.setEnabled(false);
            rb_Femenino.setEnabled(false);
            rb_Masculino.setEnabled(false);
            cb_ACD.setEnabled(false);
            cb_MP.setEnabled(false);
            cb_ING.setEnabled(false);
            cb_DR.setEnabled(false);
            cb_CA.setEnabled(false);
            cb_GLION.setEnabled(false);
            cb_CS.setEnabled(false);
            cb_Otros.setEnabled(false);
        }
        
    }
    private void autollenar(){
        usu.setCedula(txt_Cedula.getText().trim());
        
        if (txt_Cedula.getText() !=null && !txt_Cedula.getText().equals("")){
            System.out.println("tengo datoss .....");
            Object[] bi_usuario_datos = bd.bi_usuario_datos(usu.getCedula());
            String estado = (String) bi_usuario_datos[0];
                   
                if (estado !=null && !estado.equals("")){//si todo esta bien no null

                    // auto acompletando datos 
                    txt_Nombre.setText((String) bi_usuario_datos[0]);
                    if (bi_usuario_datos[1] == "masculino" ||  bi_usuario_datos[1].equals("masculino")){
                        rb_Masculino.setSelected(true);
                    }else{
                        rb_Femenino.setSelected(true);
                    }
                    String carreraaa = (String) bi_usuario_datos[2];
                    switch(carreraaa){
                        case "ACD": cb_ACD.setSelected(true); break;
                        case "MP": cb_MP.setSelected(true); break;
                        case "ING": cb_ING.setSelected(true); break;
                        case "DR": cb_DR.setSelected(true); break;
                        case "CA": cb_CA.setSelected(true); break;
                        case "GLION": cb_GLION.setSelected(true); break;
                        case "CS": cb_CS.setSelected(true); break;
                        case "Otros": cb_Otros.setSelected(true); break;
                        default: System.out.println(" no taaa");
                    }
                    // fin del auto llenado de datos 
                    
                }else{
                    // activamos los campos para agregar los datps
                    System.out.println("No esta Disponible: "+Arrays.toString(bi_usuario_datos));
                    Campos_act_dect(true);
            }
        }else{
            System.out.println("vacio no datos");
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        System.out.println("a buscar datos");
        autollenar();
        // TODO add your handling code here:
